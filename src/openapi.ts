...
paths:
  ...
  "/api/events/{eventId}/submissions/{id}":
    ...
    delete:
      tags: [submissions]
      operationId: delete_api_events_eventId_submissions_id
      summary: "Registered in app.ts. See docs/API.md for role and behaviour notes."
      requestBody:
        required: false
        content:
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ErrorEnvelope'
        '409':
          description: Conflict — accepted submission has a linked session, or the mirrored session is published.
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ErrorEnvelope'
