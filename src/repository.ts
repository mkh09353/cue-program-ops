...
export const demoSchedule: ScheduleProjection = {
 ...
 speakers:[{id:"spk-ada",name:"Ada Lovelace",email:"ada@example.test",bio:"Builder of analytical systems.",company:"Analytical Engines",isPublic:true,acceptedSubmissionId:"sub-ada"},{id:"spk-grace",name:"Grace Hopper",email:"grace@example.test",bio:"Compiler pioneer and systems leader.",company:"Navy",isPublic:false,acceptedSubmissionId:"sub-grace"},{id:"spk-lin",name:"Lin Clark",email:"lin@example.test",bio:"Making complex systems understandable.",company:"Mozilla",isPublic:false,acceptedSubmissionId:"sub-lin"},{id:"spk-margaret",name:"Margaret Hamilton",email:"margaret@example.test",bio:"Reliable software for critical missions.",company:"Hamilton Technologies",isPublic:true,acceptedSubmissionId:"sub-margaret"},{id:"spk-sam",name:"Sam Rivera",email:"sam@example.test",bio:"Eval loops for production teams.",company:"Eval Collective",isPublic:true,acceptedSubmissionId:"sub-sam"}],
 sessions:[{id:"ses-analytical",acceptedSubmissionId:"sub-ada",title:"Analytical Engines in Practice",abstract:"A practical session on reliable systems.",speakerIds:["spk-ada"],trackIds:["track-infra"],durationMinutes:45,capacity:500,status:"published",publishStatus:"published",slug:"analytical-engines"},{id:"ses-reliable-agents",acceptedSubmissionId:"sub-grace",title:"Reliable Agent Systems",abstract:"A panel on shipping agents that work.",speakerIds:["spk-ada","spk-grace"],trackIds:["track-agents","track-infra"],durationMinutes:45,capacity:700,status:"accepted",publishStatus:"draft",slug:"reliable-agents"},{id:"ses-product",acceptedSubmissionId:"sub-margaret",title:"Shipping AI Products",abstract:"Practical product lessons.",speakerIds:["spk-margaret"],trackIds:["track-product"],durationMinutes:45,capacity:300,status:"draft",publishStatus:"draft",slug:"shipping-ai-products"},{id:"ses-workshop",acceptedSubmissionId:"sub-lin",title:"Advanced Agents Workshop",abstract:"Hands-on workflow design.",speakerIds:["spk-lin"],trackIds:["track-agents"],durationMinutes:60,capacity:120,status:"accepted",publishStatus:"draft",slug:"advanced-agents"},{id:"ses-sam",acceptedSubmissionId:"sub-sam",title:"Eval Harnesses Teams Actually Use",abstract:"A field guide to eval loops that survive contact with production.",speakerIds:["spk-sam"],trackIds:["track-infra"],durationMinutes:60,capacity:100,status:"accepted",publishStatus:"draft",slug:"eval-harnesses"}],
 slots:[{id:"slot-analytical",sessionId:"ses-analytical",roomId:"room-main",startsAt:"2026-10-12T17:00:00.000Z",endsAt:"2026-10-12T17:45:00.000Z"},{id:"slot-product",sessionId:"ses-product",roomId:"room-lab",startsAt:"2026-10-12T18:00:00.000Z",endsAt:"2026-10-12T18:45:00.000Z"}]
};
