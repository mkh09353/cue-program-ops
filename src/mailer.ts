export type MailStatus = "mock_sent" | "sent" | "failed";
...
export interface Mailer { send(message: MailMessage): Promise<{ status: Exclude<MailStatus, "failed">; providerId?: string }>; }
